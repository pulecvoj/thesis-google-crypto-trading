...
# subsetting it to the common ones
load(file="49_35140_48_time_vector_15minut_ARIMA_fit_XBT.Rdata") #load time vector of the remaining one
shorter <- shorter[(shorter$time %in% c(time_vector)),]
longer <- longer[(longer$time %in% c(time_vector)),]
