...
save(minute_data,file=paste(window_start,"_", window_end,"_", lookback,"_minut_VAR_no_diff_fit_XBT.Rdata", sep = ""))
}
...
save(returns_benchmark,file=paste(window_start,"_", window_end,"_", lookback,"_minut_VAR_no_diff_benchmark_XBT.Rdata", sep = ""))
