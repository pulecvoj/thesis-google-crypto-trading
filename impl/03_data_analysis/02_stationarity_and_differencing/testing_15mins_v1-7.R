...
# *** loading data ****************************
load(file = "XMR_15minute_returns_quart.Rdata")
...
summary(ca.jo(sbst, type = "eigen"))
summary(ca.jo(sbst, type = "trace"))

# 3) testing granger causality
summary(grangertest(fifteen_minute_data$SVI,fifteen_minute_data$logreturn_price_all, order = 1)) #logreturn~SVI
summary(grangertest(fifteen_minute_data$search_negative,fifteen_minute_data$logreturn_price_all, order = 1)) #logreturn~SVI-
summary(grangertest(fifteen_minute_data$search_positive,fifteen_minute_data$logreturn_price_all, order = 1)) #logreturn~SVI+

summary(grangertest(fifteen_minute_data$SVI,fifteen_minute_data$logreturn_price_all, order = 3)) #logreturn~SVI
summary(grangertest(fifteen_minute_data$search_negative,fifteen_minute_data$logreturn_price_all, order = 3)) #logreturn~SVI-
summary(grangertest(fifteen_minute_data$search_positive,fifteen_minute_data$logreturn_price_all, order = 3)) #logreturn~SVI+

summary(grangertest(fifteen_minute_data$SVI,fifteen_minute_data$logreturn_price_all, order = 5)) #logreturn~SVI
summary(grangertest(fifteen_minute_data$search_negative,fifteen_minute_data$logreturn_price_all, order = 5)) #logreturn~SVI-
summary(grangertest(fifteen_minute_data$search_positive,fifteen_minute_data$logreturn_price_all, order = 5)) #logreturn~SVI+

summary(grangertest(fifteen_minute_data$SVI,fifteen_minute_data$logreturn_price_all, order = 10)) #logreturn~SVI
summary(grangertest(fifteen_minute_data$search_negative,fifteen_minute_data$logreturn_price_all, order = 10)) #logreturn~SVI-
summary(grangertest(fifteen_minute_data$search_positive,fifteen_minute_data$logreturn_price_all, order = 10)) #logreturn~SVI+

summary(grangertest(fifteen_minute_data$SVI,fifteen_minute_data$logreturn_price_all, order = 15)) #logreturn~SVI
summary(grangertest(fifteen_minute_data$search_negative,fifteen_minute_data$logreturn_price_all, order = 15)) #logreturn~SVI-
summary(grangertest(fifteen_minute_data$search_positive,fifteen_minute_data$logreturn_price_all, order = 15)) #logreturn~SVI+


load(file = "XMR_15minute_returns_bin.Rdata")
