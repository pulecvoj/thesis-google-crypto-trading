...
# Progress bar
 ...
 #MDA
 returns_benchmark[2,1] <- sum(five_minute_data$A_DA_5[timeframe:nrow(five_minute_data)]) / (nrow(five_minute_data) - sum(five_minute_data$A_m5[which(five_minute_data$A_m5 == 1)])-sum(is.na(five_minute_data$A_m5)))*100
 returns_benchmark[2,2] <- sum(five_minute_data$A_DA_10[timeframe:nrow(five_minute_data)],na.rm = TRUE) / (nrow(five_minute_data) - sum(five_minute_data$A_m5[which(five_minute_data$A_m10 == 1)])-sum(is.na(five_minute_data$A_m10)))*100
 returns_benchmark[2,3] <- sum(five_minute_data$A_DA_15[timeframe:nrow(five_minute_data)],na.rm = TRUE) / (nrow(five_minute_data) - sum(five_minute_data$A_m5[which(five_minute_data$A_m15 == 1)])-sum(is.na(five_minute_data$A_m15)))*100
 returns_benchmark[2,4] <- sum(five_minute_data$A_DA_30[timeframe:nrow(five_minute_data)],na.rm = TRUE) / (nrow(five_minute_data) - sum(five_minute_data$A_m5[which(five_minute_data$A_m30 == 1)])-sum(is.na(five_minute_data$A_m30)))*100
 returns_benchmark[2,5] <- sum(five_minute_data$A_DA_60[timeframe:nrow(five_minute_data)],na.rm = TRUE) / (nrow(five_minute_data) - sum(five_minute_data$A_m5[which(five_minute_data$A_m60 == 1)])-sum(is.na(five_minute_data$A_m60)))*100
