...
for(q in c(60,120,240,360)){
  ...
  save(diagnostics,file=paste(window_start,"_", window_end,"_", lookback,"_minut_ARIMA_diagnostics_XBT.Rdata", sep = ""))
...
for(q in c(60,120,240,360)){
  ...
  for(i in 1:(nrow(minute_data)-timeframe)){
    ...
    #setTkProgressBar(pb, i, label=paste( round(i/(nrow(minute_data)-timeframe)*1000, 0),"‰ done"))
    print(paste("ETH","_",q, "_",i))
    
  }
  
  save(minute_data,file=paste(window_start,"_", window_end,"_", lookback,"_one_minut_ARIMA_fit_ETH.Rdata", sep = ""))
  
  forecasts <- minute_data[which(minute_data$WN_RW_indication !=0), ]
  time_vector <- forecasts$time
  save(time_vector,file=paste(window_start,"_", window_end,"_", lookback,"_time_vector_one_minut_ARIMA_fit_ETH.Rdata", sep = ""))
  ...
  save(returns_benchmark,file=paste(window_start,"_", window_end,"_", lookback,"_minut_ARIMA_benchmark_ETH.Rdata", sep = ""))
  ...
  save(diagnostics,file=paste(window_start,"_", window_end,"_", lookback,"_minut_ARIMA_diagnostics_ETH.Rdata", sep = ""))
...
for(q in c(60,120,240,360)){
  ...
  for(i in 1:(nrow(minute_data)-timeframe)){
    ...
    #setTkProgressBar(pb, i, label=paste( round(i/(nrow(minute_data)-timeframe)*1000, 0),"‰ done"))
    print(paste("LTC","_",q, "_",i))
    
  }
  
  save(minute_data,file=paste(window_start,"_", window_end,"_", lookback,"_one_minut_ARIMA_fit_LTC.Rdata", sep = ""))
  
  forecasts <- minute_data[which(minute_data$WN_RW_indication !=0), ]
  time_vector <- forecasts$time
  save(time_vector,file=paste(window_start,"_", window_end,"_", lookback,"_time_vector_one_minut_ARIMA_fit_LTC.Rdata", sep = ""))
  ...
  save(returns_benchmark,file=paste(window_start,"_", window_end,"_", lookback,"_minut_ARIMA_benchmark_LTC.Rdata", sep = ""))
  ...
  save(diagnostics,file=paste(window_start,"_", window_end,"_", lookback,"_minut_ARIMA_diagnostics_LTC.Rdata", sep = ""))
