...
# Progress bar
 ...
 #Cumulative EURO miss
 returns_benchmark[3,1] <- sum(five_minute_data$A_SQe_5[timeframe:nrow(five_minute_data)]) / (nrow(five_minute_data) - sum(five_minute_data$A_m5[which(five_minute_data$A_m5 == 1)]))
 returns_benchmark[3,1] sum(five_minute_data$A_SQe_10[timeframe:nrow(five_minute_data)]) / (nrow(five_minute_data) - sum(five_minute_data$A_m5[which(five_minute_data$A_m5 == 1)]))
 returns_benchmark[3,1] sum(five_minute_data$A_SQe_15[timeframe:nrow(five_minute_data)]) / (nrow(five_minute_data) - sum(five_minute_data$A_m5[which(five_minute_data$A_m5 == 1)]))
 returns_benchmark[3,1] sum(five_minute_data$A_SQe_30[timeframe:nrow(five_minute_data)]) / (nrow(five_minute_data) - sum(five_minute_data$A_m5[which(five_minute_data$A_m5 == 1)]))
 returns_benchmark[3,1] sum(five_minute_data$A_SQe_60[timeframe:nrow(five_minute_data)]) / (nrow(five_minute_data) - sum(five_minute_data$A_m5[which(five_minute_data$A_m5 == 1)]))
