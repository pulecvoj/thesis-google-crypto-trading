...
# Progress bar
 ...
 save(five_minute_data,file=paste(window_start,"_", window_end,"_", lookback,"_five_minut_ARIMA_fit_XMR.Rdata", sep = ""))
 
 forecasts <- five_minute_data[which(five_minute_data$A_m5 !=1),]
 time_vector <- forecasts$time
 save(time_vector,file=paste(window_start,"_", window_end,"_", lookback,"_time_vector_five_minut_ARIMA_fit_XMR.Rdata", sep = ""))
 ...
 save(returns_benchmark,file=paste(window_start,"_", window_end,"_", lookback,"_five_minut_ARIMA_benchmark_XMR.Rdata", sep = ""))
