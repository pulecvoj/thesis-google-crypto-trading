...
save(trend,file="LTC_1minute_trend_hourly_diff_mix_quartiles.Rdata")
save(minute_data,file="LTC_1minute_returns_hourly_diff_mix_quartiles.Rdata")

sbst <- as.matrix(minute_data[ , c(18,21,22,23)])
summary(ca.jo(sbst))