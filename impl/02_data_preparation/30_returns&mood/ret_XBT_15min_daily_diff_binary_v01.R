...
save(trend,file="XBT_15minute_trend_daily_diff_binary.Rdata")
save(fifteen_minute_data,file="XBT_15minute_returns_daily_diff_binary.Rdata")

sbst <- as.matrix(fifteen_minute_data[ , c(2,3)])
summary(ca.jo(sbst))
